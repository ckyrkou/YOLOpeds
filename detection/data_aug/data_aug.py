...
class RandomHSV(object):
    ...
    def __init__(self, hue = 0.5, saturation = 0.5, brightness = 0.5):
        self.hgain=hue
        self.sgain=saturation
        self.vgain=brightness
    ...
    def augment_hsv(self,img, hgain=0.5, sgain=0.5, vgain=0.5):
        ...
        return cv2.cvtColor(img_hsv, cv2.COLOR_HSV2RGB, dst=img)  # no return needed

    def __call__(self, img, bboxes):

        img = self.augment_hsv(img,self.hgain,self.sgain,self.vgain)
